...
type Student struct {
	...
	FullName        string         `json:"full_name" gorm:"column:nama;type:varchar(100);not null"`
	Email           string         `json:"email" gorm:"type:varchar(255)"`
	StudyProgramID  int            `json:"study_program_id" gorm:"column:prodi_id;type:int"`
	StudyProgram    string         `json:"study_program" gorm:"column:prodi;type:varchar(100)"`
	Faculty         string         `json:"faculty" gorm:"column:fakultas;type:varchar(100)"`
	YearEnrolled    int            `json:"year_enrolled" gorm:"column:angkatan;type:int"`
	Status          string         `json:"status" gorm:"type:varchar(20)"`
	Dormitory       string         `json:"dormitory" gorm:"column:asrama;type:varchar(50)"`
