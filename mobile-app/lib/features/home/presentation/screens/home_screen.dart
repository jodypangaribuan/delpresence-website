...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  void _showAbsensiOptionsBottomSheet(BuildContext context, int scheduleId) {
    ...
    AttendanceService().checkAttendanceStatus(scheduleId).then((isAlreadyCompleted) {
      ...
      // Continue with showing the bottom sheet as a fallback
      showModalBottomSheet(
        context: context,
        isScrollControlled: true,
        backgroundColor: Colors.white,
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: homeState?._buildMenuItem(
                                              ...
                                              iconSize: iconSize,
                                              onTap: () {
                                                // Directly navigate to CourseSelectionScreen
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                    builder: (context) =>
