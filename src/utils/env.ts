...
export const API_URL =
  process.env.NEXT_PUBLIC_API_URL || "http://34.70.12.251:8080";
 ...
 */
export const TOKEN_EXPIRY_HOURS = parseInt(
  process.env.NEXT_PUBLIC_TOKEN_EXPIRY_HOURS || "12",
  10
);
...
export const CORS_ALLOWED_ORIGINS =
  process.env.NEXT_PUBLIC_CORS_ALLOWED_ORIGINS || "http://localhost:3000";
